        ...
        <main className="about">
          ...
          <div className="about--text">
            ...
            <p>
              ...
              renderings of popular characters, like his Avatar: The Last
              Airbender portrait series, which have regularly gone viral on
              social media.
            </p>
            <p>
            ...
            <ul>
              <li>
                <a href="http://twitter.com/medertaab">Twitter</a>
              </li>
              <li>
                <a href="http://instagram.com/medertaab">Instagram</a>
              </li>
            </ul>
            <h3>Contact</h3>
            <ul>
              <li>
                <a href="medertaab@gmail.com">medertaab@gmail.com</a>
              </li>
              <li>
